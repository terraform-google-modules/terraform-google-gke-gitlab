...
| gke\_version | Version of GKE to use for the GitLab cluster | `string` | `"1.25"` | no |
| helm\_chart\_version | Helm chart version to install during deployment | `string` | `"7.0.1"` | no |
